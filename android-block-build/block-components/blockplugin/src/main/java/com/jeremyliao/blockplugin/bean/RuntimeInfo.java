...
public class RuntimeInfo {
    ...
    public Map<String, String> getOriToNewBeanMap() {
        return oriToNewBeanMap;
    }

    public void setOriToNewBeanMap(Map<String, String> oriToNewBeanMap) {
        this.oriToNewBeanMap = oriToNewBeanMap;
    }
